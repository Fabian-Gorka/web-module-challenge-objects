...
const taco = createMenuItem('tacos', '8', 'lunch');
console.log(taco);
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 1b: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
*/ const pizza = createMenuItem('pizza', '4', 'lunch');
   const hotDog = createMenuItem('Hot Dog', '3.50', 'lunch');
   const nachos = createMenuItem('nachos', '3', 'lunch');
   console.log(pizza);
   console.log(hotDog);
   console.log(nachos);
...
reviews.push({name:'fabian', rating:'4.5', feedback:'the food was satisfying and the service was great'});
console.log(reviews)
